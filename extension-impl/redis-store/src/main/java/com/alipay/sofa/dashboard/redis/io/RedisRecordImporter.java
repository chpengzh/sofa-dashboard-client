...
public class RedisRecordImporter extends RedisStoreBase implements RecordImporter {
    ...
    private static final Logger                LOGGER = LoggerFactory
                                                          .getLogger(RedisRecordImporter.class);

    private final StringRedisTemplate          template;

    private final SofaDashboardRedisProperties props;

    public RedisRecordImporter(StringRedisTemplate template, SofaDashboardRedisProperties props) {
